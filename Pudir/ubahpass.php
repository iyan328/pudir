    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="homepudir.php">Pudir</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="homepudir.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
					<li>
                        ...
                        <ul id="m" class="collapse">
                            <li>
                                <a href="../upload-download-files/spm1.php"><i class="fa fa-fw fa-tag"></i>Surat Pengantar Magang</a>
                            </li>
                        </ul>
                    </li>
					<li class="active">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ubah Password <small><?php echo $hak?></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i><a href="homepudir.php"> Dashboard </a>
                            </li>
							<li>
...
<?php
		...
		if (isset($_POST['tblEdit'])){
			...
			if(empty($_POST['pass'])){
				...
				$kueri = mysql_query($sql);
				if ($kueri){
				echo "<script> document.location='homepudir.php'</script>";
			}
			else {
				echo "<script> alert('Pasword gagal diubah');document.location='homepudir.php'</script>";
				echo mysql_error();
			}
				}
		} 
